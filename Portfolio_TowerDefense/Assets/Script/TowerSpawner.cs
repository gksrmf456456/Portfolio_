...
public class TowerSpawner : MonoBehaviour
{
    ...
    [SerializeField]
    private EnemySpawner enemySpawner;  // 현재 맵에 존재하는 적 리스트 정보를 얻기 위하여
    [SerializeField]
    private PlayerGold playerGold;      // 타워 건설시 골드 감소를 위하여
    [SerializeField]
    ...
    public void SpawnTower(Transform tileTransform)
    {
        ...
        // 현재 타일 위치에 이미 타워가 건설되어 있으면 타워 건설 x
        if(tile.isBuildTower == true)
        {
            // 현재 위치에 타워 건설 불가능하다고 출력
